...
class Event extends Model implements HasMedia
{
    ...
    public static function getForm(): array
    {
        return [
            Section::make('Event')
                ->description(new HtmlString('Please be sure to read the <a href="/rules"><span class="text-red-500 font-bold underline">Community Guidelines and Rules</a> before posting an event.'))
                ->columns(2)
                ->schema([
                    TextInput::make('name')
                        ->required()
